...
describe('describeOSVersionDropdownItem', () => {
  ...
  it('shows not found on partial failure', () => {
    expect(describeOSVersionDropdownItem({ data: [] }, false, 9)).toBe(
      'Full support ends: not found | Maintenance support ends: not found',
    );
    expect(describeOSVersionDropdownItem({ data: [data9] }, false, 9)).toBe(
      'Full support ends: not found | Maintenance support ends: April 2027',
    );
    expect(describeOSVersionDropdownItem({ data: [data9_9] }, false, 9)).toBe(
      'Full support ends: April 2026 | Maintenance support ends: not found',
    );
